...
export const APS_2024_GUIDANCE: GuidanceNote[] = [
  // Buyer's Offer Fields (for review screen)
  {
    ...
    description: 'The total amount the buyer is offering to pay for your property.',
    tips: [
  ...
  },
  {
    ...
    description: 'When the buyer can physically take possession of the property.',
    tips: [
  ...
  },
  {
    ...
    tips: [
      'Prefilled from your listing',
      'Update if you\'ve changed lawyers',
    ],
  },
  {
    section: 'Lawyer Information (Review)',
  ...
  },
  {
    ...
    description: 'List any items you want to keep and remove before the buyer moves in.',
  ...
  },
  {
    ...
    field: 'rentalItems',
    title: 'Rental Items',
    description: 'Any items on the property that are rented or leased (buyer will assume these).',
  ...
  },
  {
    ...
    description: 'Any other information you want to include about the property or sale.',
    tips: [
